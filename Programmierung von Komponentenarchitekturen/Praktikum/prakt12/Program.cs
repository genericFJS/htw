...
namespace Praktikum1 {
    class Program {
        static void Main(string[] args) {
            ...
            //double[] min = [5]; // Klammer bei Deklaration falsch, Initialisierung des Arrays nicht min Array-Name
            ...
            // Aufgabe 4
            // (1): foo in class C in math
            // (2): foo2 in class 2 in math
            // (3): foo2 in class C in ns in math1
            // (4): foo in class C in ??
            // (5): foo in class C in ??

            // Aufgabe 5
            // a: Deklaration der Variable w (darf noch nicht existieren) vom Typ widget
            // b: Deklaration der Funktion w mit Ausgabe widget (die null ist)

...
\end{itemize}
\begin{tikzpicture}
\draw  (-2.5,2.5)node[below right]{\lstinline"Singleton"} rectangle (3,2);
\draw  (-2.5,2) node[below right]{\lstinline"- instanz: singleton"} rectangle (3,0.5);
\draw  (-2.5,0.5) node[below right, align=left]{\lstinline"- singleton();"\\\lstinline"+ GibInstanz(): singleton;"} rectangle (3,-0.5);
\end{tikzpicture}
...
\begin{tikzpicture}
\draw  (-2.5,2.5)node[below right]{\lstinline"Prototyp"} rectangle (3,2);
\draw  (-2.5,2) node[below right]{\lstinline""} rectangle (3,1);
\draw  (-2.5,1) node[below right, align=left]{\lstinline"+ clone();"} rectangle (3,0);
\end{tikzpicture}

...
\chair{Lehrstuhl für Betriebliche Informations- und Kommunikationssysteme/Datenbanksysteme}
\subject{lecture}
\title{Datenbanksysteme 1}
\author{Falk-Jonatan Strube}
\professor{Prof. Dr.-Ing. Axel Toll}

\begin{document}
\maketitle
\tableofcontents
\slidePath{Vorlesung/oneperpage/Kap}
...
\draw [double](-1,-3) -- (1,0);
\end{tikzpicture}
\slides[1]{3_Beispiele}{1, scale=0.8}
...
\end{tikzpicture}\\
UNION
\slides[1]{3_Beispiele}{2, scale=0.8}
...
\end{tikzpicture}\\
INTERSECTION
\slides[1]{3_Beispiele}{3, scale=0.8}
...
$R_1 \setminus R_2 \not = R_2 \setminus R_1$\\
DIFFERENCE
\slides[1]{3_Beispiele}{4, scale=0.8}
...
\end{tikzpicture}
\slides[1]{3_Beispiele}{7, scale=0.8}
...
\end{tikzpicture}
\slides[1]{3_Beispiele}{5, scale=0.8}
...
\end{tikzpicture}
\slides[1]{3_Beispiele}{6, scale=0.8}
...
\end{itemize}
\slides[1]{3_Beispiele}{8, scale=0.8}
...
\slides[1]{3}{8}
\slides[1]{3_Beispiele}{9, scale=0.8}
\slides[1]{3_Beispiele}{10, scale=0.8}
...
\slides[1]{5}{1, scale=0.8}
\slides[1]{5}{2, scale=0.8}
\subsection{Entities und Relationships (ERM-Diagramm)}
\slides[1]{5}{3, scale=0.8}
\slides[1]{5}{4, scale=0.8}
\subsection{Kardinalität und Komplexität von Beziehungen}
\slides[1]{5}{5, scale=0.8}
\subsection{Semantische Beziehungen am Beispiel}
\slides[1]{5}{6, scale=0.8}
\subsection{Konstruktion semantischer Objekte}
\slides[1]{5}{7, scale=0.8}
\slides[1]{5}{8, scale=0.8}
\slides[1]{5}{9, scale=0.8}
\slides[1]{5}{10, scale=0.8}
\slides[1]{5}{11, scale=0.8}
\slides[1]{5}{12, scale=0.8}
\subsection{Abbildung des Entity-Relationship-Modells auf normalisierte Relationen}
\slides[1]{5}{13, scale=0.8}
\slides[1]{5}{14, scale=0.8}
\slides[1]{5}{15, scale=0.8}
\slides[1]{5}{16, scale=0.8}
\slides[1]{5}{17, scale=0.8}
\subparagraph{Bsp. 1:} Vertrieb
\slides[1]{5_BspVertrieb}{1, scale=0.8}
\subparagraph{Bsp. 2:} Rechnung
\slides[1]{5_BspRechnung}{1, scale=0.5}

\subparagraph{Bsp. 3:} Projekt-Ableitung der Relationen
\slides[1]{5}{18, scale=0.8}
\begin{tikzpicture}[scale=0.5]

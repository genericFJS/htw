...
<body>
	...
	<div>
		...
		<main class="ui-content ui-page-theme-a" data-form="ui-page-theme-a" role="main">
			<?php
		...
		<footer data-role="footer" class="ui-footer ui-bar-inherit">
			<div id="footerContent" data-role="navbar" class="ui-navbar" role="navigation">
    		<?php
						// zeige Fußzeile an

...
\begin{enumerate}
\item $|v| \geq 1$, $|uv|\geq n$ \quad ($u, w$ können auch $\varepsilon$ sein)
...
Aus $|uv|\geq n$ folgt aber, dass $v$ kein $b$ enthält. aus $|v|\geq 1$ folgt, dass $v$ mindestens ein $a$ enthält.\\
ABB 48
...
\item $x$ finden (trivial)
\item durch 1.) einschränken
\item durch 2.) zum Widerspruch führen
\end{itemize}

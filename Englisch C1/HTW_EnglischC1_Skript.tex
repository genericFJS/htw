...
\setCustomTitle{English C1}
\setCustomSubtitle{Notes}
\setCustomAuthor{Falk-Jonatan Strube}
%\setCustomNoteA{TitlepageNoteBeforeAuthor}
\setCustomNoteB{Lecture by B.Arch. B.Sc. Darlene Kilian}

\setCustomSignature{\footnotesize{\textcolor{darkgray}{Notes by\\ \customAuthor}}}	% Formatierung der Signatur in der Fußzeile
\setCustomTitleAuthor{\textcolor{darkgray}{Notes by \customAuthor}}	% Formatierung des Autors auf dem Titelblatt
